...
const FAQ = () => {
  return (
    <>
      ...
      <section id="frequentlyAskedQuestions" className="w-full mb-0 2xl:mb-20">
      ...
      <section id="faqSection" className="w-full mb-16 md:mb-28 lg:mb-40 2xl:mb-40 pt-20 2xl:pt-0">

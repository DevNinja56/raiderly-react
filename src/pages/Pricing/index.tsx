...
const Pricing = () => {
  return (
    ...
    <>
      ...
      <section id="subscriptionSection" className="w-full mb-16 md:mb-28 lg:mb-40 2xl:mb-60">
      ...
      <section id="moreDetailSection" className="w-full mb-8 md:mb-20 lg:mb-32 2xl:mb-52 hidden lg:block">
        <div className="max-w-contentSmallScreenWidth md:max-w-contentLargeScreenWidth mx-auto w-full flex flex-col items-center gap-12 lg:gap-20">
      ...
      <section id="startingWithRaiderlySection" className="w-full mb-16 md:mb-28 lg:mb-40 2xl:mb-60">

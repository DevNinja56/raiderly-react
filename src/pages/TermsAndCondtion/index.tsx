...
const TermsAndCondition = () => {
  return (
    <>
      ...
      <section id="termsofUse" className="w-full mb-16 md:mb-20 lg:mb-20 2xl:mb-40">
        <div className="w-full relative pt-32 pb-24 lg:py-32 2xl:py-40 flex justify-start 2xl:justify-center flex-col gap-28 md:gap-40 lg:gap-32 2xl:gap-0 h-auto">
          ...
          <div className="flex flex-col items-center z-10 max-w-contentSmallScreenWidth md:max-w-contentLargeScreenWidth mx-auto w-full pt-5 2xl:pt-0">
            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-eightyPixel font-extrabold text-center mb-1 leading-relaxed md:leading-relaxed lg:leading-relaxed w-10/12"><span className="text-mainColor">Terms</span> of Use</h1>
          </div>
        </div>
      </section>
      ...
      <section id='descriptionT&C' className='w-full mb-16 md:mb-28 lg:mb-40 2xl:mb-60'>

  ...
  return (
    <div className="flex flex-col items-center gap-8 lg:gap-12 w-full">
      <div className="relative w-full">
        ...
        <Button text='Message investors' padding='px-6 lg:px-9 py-3' className='bg-mainColor text-white font-medium text-base lg:text-lg hover:opacity-95' icon={<Arrow />}/>
    </div>
  )
}
